...
class GameInfo:
    def __init__(self):
        self.TitleId : str = "495B3"
        self.SecretKey : str = "RHNY99JX187QACWEX4J3DKRMCXE68EGJ8NEABO7BMZIDZTWNMU"
        self.ApiKey : str = "OC|1671350990587516|72ac739d26ddeee80b26fb6a4669ba64"
    ...
    return """
        <html>
            ...
            <body style="font-family: 'Inter', sans-serif; background: linear-gradient(to bottom, #004d00, #00cc00); color: white; text-align: center; padding: 50px;">
                ...
                <img src="https://dummyimage.com/512x512/000/fff.png" alt="if u see this text it dont work" style="max-width: 500px; border-radius: 20px; box-shadow: 0 4px 20px rgba(0,0,0,0.3); display: block; margin: 30px auto;">
...
def titledata():
    response_data = {
        ...
        "MOTD": "<color=blue>WELCOME TO</color> <color=purple>TOP TAG!</color>\n\n<color=purple>OWNER -</color> <color=blue>TUTEL</color> <color=purple>|</color> <color=purple>CO-OWNER -</color> <color=blue>ADRLON</color>",
